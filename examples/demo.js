...
const pricingRules = [
  ...
  new BulkDiscountRule('ult_large', 4, 39.90), // Bulk discount on Unlimited 5GB
...
console.log('   Promotion: 3-for-2 deal applied (pay for 2 out of 3 Unlimited 1GB)\n');
...
console.log('   Promotion: Bulk discount applied (4+ Unlimited 5GB at $39.90 each)\n');
...
console.log('📋 Scenario 4: 1 x Unlimited 1GB, 1 x 1GB Data-pack with promo code');
...
console.log('   Promotion: 10% discount applied with promo code "I<3AMAYSIM"\n');
